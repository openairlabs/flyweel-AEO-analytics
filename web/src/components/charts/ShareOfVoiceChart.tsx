...
import type { ShareOfVoiceData } from "@/lib/metrics";
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip content="Percentage of LLM responses that mention this brand. Calculated as: (responses mentioning brand ÷ total responses) × 100. Higher means more visibility." />
        </div>
        <div className="flex items-center gap-2">
